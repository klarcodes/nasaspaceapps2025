    ...
    <div class="leaflet-sidebar-tabs">
        ...
        <ul role="tablist">
            ...
            if (isset($_SESSION['user_id'])) {
                ...
                <li><a href="#editar" id="editar" role="tab"><i class="bi bi-arrows-move"></i></a></li>
                <?php
            }
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul class="tree-submenu show">
                        ...
                        <li><input class="input" type="radio" name="mapa" id="input" onclick="mapas(satelite)">
                            Satellite
                        </li>
                ...
                <li>
                    ...
                    <ul class="tree-submenu show">
                        ...
                        <li>
                            <span class="tree-toggle collapsed" onclick="toggleSubmenu(this)"><b>Vegetation
                                    Indices</b></span>
                            <ul class="tree-submenu">

                                <li><input class="input" type="checkbox" id="MODIS_Aqua_L3_EVI_Monthly"
                                        onclick="addRemoverLayerWms('MODIS_Aqua_L3_EVI_Monthly', '2025-08-31', 'MODIS_Aqua_L3_EVI_Monthly', map)">
                                    MODIS_Aqua_L3_EVI_Monthly
                                </li>

                                <li><input class="input" type="checkbox" id="MODIS_Aqua_L3_EVI_16Day"
                                        onclick="addRemoverLayerWms('MODIS_Aqua_L3_EVI_16Day', '2025-08-31', 'MODIS_Aqua_L3_EVI_16Day', map)">
                                    MODIS_Aqua_L3_EVI_16Day
                                </li>

                                <li><input class="input" type="checkbox" id="MODIS_Aqua_L3_NDVI_Monthly"
                                        onclick="addRemoverLayerWms('MODIS_Aqua_L3_NDVI_Monthly', '2025-08-31', 'MODIS_Aqua_L3_NDVI_Monthly', map)">
                                    MODIS_Aqua_L3_NDVI_Monthly
                                </li>

                                <li><input class="input" type="checkbox" id="MODIS_Aqua_L3_NDVI_16Day"
                                        onclick="addRemoverLayerWms('MODIS_Aqua_L3_NDVI_16Day', '2025-08-31', 'MODIS_Aqua_L3_NDVI_16Day', map)">
                                    MODIS_Aqua_L3_NDVI_16Day
                                </li>

                                <li><input class="input" type="checkbox" id="Landsat_WELD_NDVI_Global_Monthly"
                                        onclick="addRemoverLayerWms('Landsat_WELD_NDVI_Global_Monthly', '2001-11-30', 'Landsat_WELD_NDVI_Global_Monthly', map)">
                                    Landsat_WELD_NDVI_Global_Monthly
                                </li>

                                <li><input class="input" type="checkbox" id="Landsat_WELD_NDVI_Global_Annual"
                                        onclick="addRemoverLayerWms('Landsat_WELD_NDVI_Global_Annual', '2001-11-30', 'Landsat_WELD_NDVI_Global_Annual', map)">
                                    Landsat_WELD_NDVI_Global_Annual
                                </li>

                                <li><input class="input" type="checkbox" id="VIIRS_SNPP_NDVI_8Day"
                                        onclick="addRemoverLayerWms('VIIRS_SNPP_NDVI_8Day', '2025-08-31', 'VIIRS_SNPP_NDVI_8Day', map)">
                                    VIIRS_SNPP_NDVI_8Day
                                </li>

                                <li><input class="input" type="checkbox" id="VIIRS_SNPP_EVI_8Day"
                                        onclick="addRemoverLayerWms('VIIRS_SNPP_EVI_8Day', '2025-08-31', 'VIIRS_SNPP_EVI_8Day', map)">
                                    VIIRS_SNPP_EVI_8Day
                                </li>

                                <li><input class="input" type="checkbox" id="MODIS_Terra_NDVI_8Day"
                                        onclick="addRemoverLayerWms('MODIS_Terra_NDVI_8Day', '2025-08-31', 'MODIS_Terra_NDVI_8Day', map)">
                                    MODIS_Terra_NDVI_8Day
                                </li>

                                <li><input class="input" type="checkbox" id="MODIS_Terra_EVI_8Day"
                                        onclick="addRemoverLayerWms('MODIS_Terra_EVI_8Day', '2025-08-31', 'MODIS_Terra_EVI_8Day', map)">
                                    MODIS_Terra_EVI_8Day
                                </li>

                                <li><input class="input" type="checkbox" id="MODIS_Terra_L3_NDVI_16Day"
                                        onclick="addRemoverLayerWms('MODIS_Terra_L3_NDVI_16Day', '2025-08-31', 'MODIS_Terra_L3_NDVI_16Day', map)">
                                    MODIS_Terra_L3_NDVI_16Day
                                </li>

                                <li><input class="input" type="checkbox" id="MODIS_Terra_L3_NDVI_Monthly"
                                        onclick="addRemoverLayerWms('MODIS_Terra_L3_NDVI_Monthly', '2025-08-31', 'MODIS_Terra_L3_NDVI_Monthly', map)">
                                    MODIS_Terra_L3_NDVI_Monthly
                                </li>

                                <li><input class="input" type="checkbox" id="MODIS_Terra_L3_EVI_16Day"
                                        onclick="addRemoverLayerWms('MODIS_Terra_L3_EVI_16Day', '2025-08-31', 'MODIS_Terra_L3_EVI_16Day', map)">
                                    MODIS_Terra_L3_EVI_16Day
                                </li>

                                <li><input class="input" type="checkbox" id="MODIS_Terra_L3_EVI_Monthly"
                                        onclick="addRemoverLayerWms('MODIS_Terra_L3_EVI_Monthly', '2025-08-31', 'MODIS_Terra_L3_EVI_Monthly', map)">
                                    MODIS_Terra_L3_EVI_Monthly
                                </li>

                                <li><input class="input" type="checkbox" id="MISR_Land_NDVI_Average_Monthly"
                                        onclick="addRemoverLayerWms('MISR_Land_NDVI_Average_Monthly', '2025-08-31', 'MISR_Land_NDVI_Average_Monthly', map)">
                        ...
                        <li>
                            <span class="tree-toggle collapsed" onclick="toggleSubmenu(this)"><b>Vegetation Disturbance
                                    Status</b></span>
                            <ul class="tree-submenu">

                                <li><input class="input" type="checkbox" id="OPERA_L3_DIST-ALERT-HLS_Color_Index"
                                        onclick="addRemoverLayerWms('OPERA_L3_DIST-ALERT-HLS_Color_Index', '2025-08-31', 'OPERA_L3_DIST-ALERT-HLS_Color_Index', map)">
                        ...
                        <li>
                            <span class="tree-toggle collapsed" onclick="toggleSubmenu(this)"><b>Urban
                                    Extents</b></span>
                            <ul class="tree-submenu">

                                <li><input class="input" type="checkbox" id="GRUMP_Urban_Extents_Grid_1995"
                                        onclick="addRemoverLayerWms('GRUMP_Urban_Extents_Grid_1995', '2025-08-31', 'GRUMP_Urban_Extents_Grid_1995', map)">
                                    GRUMP_Urban_Extents_Grid_1995
                                </li>

                                <li><input class="input" type="checkbox" id="LECZ_Urban_Rural_Extents_Below_10m"
                                        onclick="addRemoverLayerWms('LECZ_Urban_Rural_Extents_Below_10m', '2025-08-31', 'LECZ_Urban_Rural_Extents_Below_10m', map)">
                        ...
                        <li>
                            ...
                            <ul class="tree-submenu">
                                ...
                                <li><input class="input" type="checkbox" id="MODIS_Water_Mask"
                                        onclick="addRemoverLayerWms('MODIS_Water_Mask', '2025-01-01', 'MODIS_Water_Mask', map)">
                                    MODIS_Water_Mask
                                </li>

                                <li><input class="input" type="checkbox" id="GRanD_Reservoirs"
                                        onclick="addRemoverLayerWms('GRanD_Reservoirs', '2025-08-31', 'GRanD_Reservoirs', map)">
                                    GRanD_Reservoirs
                                </li>
                        ...
                        <li>
                            <span class="tree-toggle collapsed" onclick="toggleSubmenu(this)"><b>Human Built-up And
                                    Settlement Extent</b></span>
                            <ul class="tree-submenu">

                                <li><input class="input" type="checkbox"
                                        id="Landsat_Human_Built-up_And_Settlement_Extent"
                                        onclick="addRemoverLayerWms('Landsat_Human_Built-up_And_Settlement_Extent', '2025-10-03', 'Landsat_Human_Built-up_And_Settlement_Extent', map)">
                ...
                <li>
                    <span class="tree-toggle expanded" onclick="toggleSubmenu(this)"><b>Environmental
                            Analysis</b></span>
                    <ul class="tree-submenu show">
                        ...
                        <li>
                            <input class="input" type="checkbox"
                                onclick="addRemoverLayer2('categoria', map, 'erosao_assoreamento', nasa_conteudo, 'Erosao e Assoreamento')"
                                id="erosao_assoreamento"> Erosao e Assoreamento
                        </li>
...
try {
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        <input class="input" type="checkbox"
                            onclick="addRemoverLayer2('gid', map, <?php echo $row['gid']; ?>, nasa_conteudo, '<?php echo $row['titulo'] ?>', 'editLayer<?php echo $row['gid'] ?>', 'editModalLayer<?php echo $row['gid'] ?>', 'deleteModalLayer<?php echo $row['gid'] ?>')"
                            id="<?php echo $row['gid'] ?>"> <?php echo $row['titulo'] ?>

                        <button id="editModalLayer<?php echo $row['gid'] ?>"
                            style=" display: none; background: transparent; cursor: pointer; border: none; font-size: 14px;"
                            class="btn btn-info" data-bs-toggle="modal"
                            data-bs-target="#geoModal<?php echo $row['gid'] ?>">📍</button>

                        <button style="display: none; background: transparent; cursor: pointer; border: none; font-size: 14px;"
                            class="btn btn-success" id="editLayer<?php echo $row['gid'] ?>"
                            onclick="addRemoverLayerEdit2(nasa_options, map, <?php echo $row['gid']; ?>, nasa_conteudo, '<?php echo $row['titulo'] ?>', 'editLayer<?php echo $row['gid'] ?>', 'geom<?php echo $row['gid']; ?>')">✏️</button>

                        <button id="deleteModalLayer<?php echo $row['gid'] ?>"
                            style="display: none; background: transparent; cursor: pointer; border: none; font-size: 14px;"
                            class="btn btn-info" data-bs-toggle="modal"
                            data-bs-target="#deleteGeoModal<?php echo $row['gid'] ?>">❌</button>

                        <!-- Modal -->
                        <div class="modal fade" id="deleteGeoModal<?php echo $row['gid'] ?>" data-bs-backdrop="static"
                                ...
                                <div class="modal-content shadow-lg">
                                    ...
                                    <div class="modal-body">
                                        <form id="polygonDeleteForm<?php echo $row['gid'] ?>">
                                            ...
                                            <!-- Mensagem de retorno -->
                                            <div id="polygonDeleteMessage<?php echo $row['gid'] ?>" class="mb-3"
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="geoModal<?php echo $row['gid'] ?>" data-bs-backdrop="static"
                            data-bs-keyboard="false" tabindex="-1" aria-labelledby="geoModalLabel<?php echo $row['gid'] ?>"
                            aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                    ...
                                    <div class="modal-body">
                                        <form id="polygonEditForm<?php echo $row['gid'] ?>">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="title<?php echo $row['gid'] ?>"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="content" id="content<?php echo $row['gid'] ?>"
                                                    hidden><?php echo $row['descricao']; ?></textarea>
                                            </div>

                                            <!-- Categoria -->
                                            <div class="mb-3">
                                                <label for="categoria<?php echo $row['gid'] ?>"
                                                    class="form-label">Category</label>
                                                <select name="categoria" id="categoria<?php echo $row['gid'] ?>"
                                                    class="form-select">
                                                    <option value="">-- Selecione a categoria --</option>
                                                    <option value="desmatamento" <?php if ($row['categoria'] == 'desmatamento')
                                                        echo 'selected'; ?>>Desmatamento e Perda de Cobertura Vegetal</option>
                                                    <option value="poluicao" <?php if ($row['categoria'] == 'poluicao')
                                                        echo 'selected'; ?>>Poluição Atmosférica e Industrial</option>
                                                    <option value="enchentes" <?php if ($row['categoria'] == 'enchentes')
                                                        echo 'selected'; ?>>Enchentes e Inundações</option>
                                                    <option value="ilhas_calor" <?php if ($row['categoria'] == 'ilhas_calor')
                                                        echo 'selected'; ?>>Ilhas de Calor e Falta de Áreas Verdes</option>
                                                    <option value="erosao_assoreamento" <?php if ($row['categoria'] == 'erosao_assoreamento')
                                                        echo 'selected'; ?>>Erosão,
                                                        Assoreamento e Impacto em Rios</option>
                                                    <option value="urbanizacao" <?php if ($row['categoria'] == 'urbanizacao')
                                                        echo 'selected'; ?>>Saneamento e Urbanização Desordenada</option>
                                                    <option value="riscos_geologicos" <?php if ($row['categoria'] == 'riscos_geologicos')
                                                        echo 'selected'; ?>>Riscos
                                                        Geológicos e Geotécnicos</option>
                                                    <option value="escassez_hidrica" <?php if ($row['categoria'] == 'escassez_hidrica')
                                                        echo 'selected'; ?>>Escassez e
                                                        Contaminação Hídrica</option>
                                                </select>
                                            </div>

                                            <!-- Imagem -->
                                            <div class="mb-3">
                                                <label for="featured_image<?php echo $row['gid'] ?>"
                                                    class="form-label">Image</label>
                                                <?php if ($row['imagem_dest']): ?>
                                                    <div class="mb-2">
                                                        <img src="./imagens/<?php echo htmlspecialchars($row['imagem_dest']); ?>"
                                                            style="max-height:150px;">
                                                        <div class="form-text">Current Image</div>
                                                    </div>
                                                <?php endif; ?>
                                                <input type="file" class="form-control"
                                                    id="featured_image<?php echo $row['gid'] ?>" name="featured_image"
                                                    accept="image/*">
                                                <div class="form-text">Máx 5MB. JPG, PNG ou GIF.</div>
                                            </div>

                                            <!-- Geometria -->
                                            <input type="hidden" name="geom" id="geom<?php echo $row['gid']; ?>"
                                                value='<?php echo $row['geom_json']; ?>'>

                                            <!-- Geometria -->
                                            <input type="hidden" name="gid" value='<?php echo $row['gid']; ?>'>

                                            <!-- Mensagem -->
                                            <div id="polygonEditMessage<?php echo $row['gid'] ?>" class="mb-3"
                                                style="display:none;"></div>

                                            <!-- Botão -->
                                            <button type="button" id="polygonEditBtn<?php echo $row['gid'] ?>"
                        ...
                        <script>
                            ...
                            document.getElementById("abrirAutopan").addEventListener("click", function () {
                                ...
                                // Remove a aba ativa atual
                                document.querySelector('.leaflet-sidebar-tabs .active')?.classList.remove('active');
                                document.querySelector('.leaflet-sidebar-content .active')?.classList.remove('active');

                                // Ativa a aba que você quer
                                document.querySelector('a[href="#autopan"] i').classList.add('active');
                                document.getElementById('autopan').classList.add('active');
                            });

                            document.getElementById("editar").addEventListener("click", function () {
                                // document.querySelector('a[href="#editar"]').click();
                                // Remove a aba ativa atual
                                document.querySelector('.leaflet-sidebar-tabs .active')?.classList.remove('active');
                                document.querySelector('.leaflet-sidebar-content .active')?.classList.remove('active');

                                // Ativa a aba que você quer
                                document.querySelector('a[href="#editar"] i').classList.add('active');
